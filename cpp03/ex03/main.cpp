...
int main(void) {
	...
	DiamondTrap	DiamondTrapB(DiamondTrapA);
	DiamondTrap	DiamondTrapC("DiamondTrapC");

	DiamondTrapB = DiamondTrapC;

	DiamondTrapA.attack(DiamondTrapB.getname());
	DiamondTrapB.takeDamage(DiamondTrapA.getattack_damage());
	std::cout << "DiamondTrapA EP: " << DiamondTrapA.getenergy_point() << std::endl;
	std::cout << "DiamondTrapB HP: " << DiamondTrapB.gethit_point() << std::endl;
	DiamondTrapB.beRepaired(10);
	std::cout << "DiamondTrapB HP: " << DiamondTrapB.gethit_point() << std::endl;
	std::cout << "DiamondTrapB EP: " << DiamondTrapB.getenergy_point() << std::endl;
	DiamondTrapB.whoAmI();
}